      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "2rem", alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.75rem" }}>
          ...
          <div>
            ...
            <h1 style={{ fontSize: "1.8rem", fontWeight: 700, color: "var(--text)", lineHeight: 1.2, marginBottom: "0.75rem" }}>
              {skill.name}
            </h1>
            <p style={{ color: "var(--text-dim)", fontSize: "1rem", lineHeight: 1.65 }}>
              {skill.description}
            </p>
          </div>
          ...
          >
            <h2
              className="mono"
              style={{ color: "var(--text-muted)", fontSize: "0.65rem", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "1rem" }}
            >
              Overview
            </h2>
        ...
        >
          ...
          <div style={{ textAlign: "center", padding: "0.5rem 0" }}>
            <div className="mono" style={{ color: "var(--text-muted)", fontSize: "0.62rem", letterSpacing: "0.12em", marginBottom: "0.4rem" }}>
              ONE-TIME PURCHASE
            </div>
            <div className="mono" style={{ color: "#f5a623", fontSize: "2.2rem", fontWeight: 700 }}>
              ${skill.price}
              <span style={{ color: "rgba(245,166,35,0.5)", fontSize: "1rem" }}> USDC</span>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
            {[
              ...
              <div key={label}>
                <div className="mono" style={{ color: "var(--text-muted)", fontSize: "0.6rem", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.2rem" }}>
                  {label}
                </div>
                <div className="mono" style={{ color: "var(--text-dim)", fontSize: "0.82rem", fontWeight: 500 }}>
                  {value}
                </div>
              </div>
            ))}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
            ...
            <div>
              ...
              <div className="mono" style={{ color: "var(--text-muted)", fontSize: "0.62rem" }}>
                Developer
              </div>
            </div>
          </div>
          ...
          {purchase.status === 'error' && (
            <p style={{ fontSize: "0.68rem", color: "#cc6666", textAlign: "center" }}>
              {purchase.message}
            </p>
          )}
          <button
